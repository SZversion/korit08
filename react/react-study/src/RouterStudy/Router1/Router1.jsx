  ...
  return (
    <>
      <div css={layout}>
        ...
        <Routes>
          <Route path="color/red" element={<main css={main("red")}></main>}></Route>
          <Route path="color/blue" element={<main css={main("blue")}></main>}></Route>
          <Route path="color/orange" element={<main css={main("orange")}></main>}></Route>
        </Routes>
