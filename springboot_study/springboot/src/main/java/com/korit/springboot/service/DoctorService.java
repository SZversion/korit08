        ...
        departmentRepository.findByDepartmentName(dto.getDepartmentName())
                .ifPresentOrElse(
                        (departmentEntity -> {
                            ...
                            entity.setDoctorDepartment(departmentEntity.getId());
                            doctorRepository.save(entity);
                        }),
                        () -> {
                            DepartmentEntity department = DepartmentEntity.builder()
                                    .departmentName(dto.getDepartmentName()).build();
                            DepartmentEntity entity = departmentRepository.save(department);
                            DoctorEntity savedEntity = dto.toEntity();
                            savedEntity.setDoctorDepartment(entity.getId());
